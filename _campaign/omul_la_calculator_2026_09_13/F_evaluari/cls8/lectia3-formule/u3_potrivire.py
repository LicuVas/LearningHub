...
SRC = Path(r"C:\00\Projects\LearningHub\content\tic\cls8\m1-excel-fundamente\lectia3-formule.html")  # copiat din lectia2-date, schimbata calea + TERMEN
...
TERMEN = {1: "semnul =|egal", 2: "recalculeaza automat", 3: "numere fixe", 4: "=sum(", 5: "relativ",
          6: "recalculeaza", 7: "$b$1"}
for a in atomi:
