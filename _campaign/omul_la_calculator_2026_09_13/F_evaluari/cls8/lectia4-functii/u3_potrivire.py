...
SRC = Path(r"C:\00\Projects\LearningHub\content\tic\cls8\m1-excel-fundamente\lectia4-functii.html")  # copiat din lectia3-formule, schimbata calea + TERMEN
...
TERMEN = {1: "semnul egal|incepe cu =", 2: "min cauta|min gaseste", 3: "average aduna|media aritmetica", 4: "max gaseste|max returneaza",
          5: "counta numara", 6: "average ignora celulele goale", 7: "sum(b2:b9)", 8: "64/8", 9: "if (functia de decizie)"}
for a in atomi:
