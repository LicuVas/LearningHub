...
| 2 | Nu încape în 50 de minute | poarta (U12) pe `03_pasi.json` + `masuri.json` (2946 de cuvinte) | vezi `log.json` / ieșirea porții: citirea singură ≈ 24 min + pornire 8; proiectul + 3 exerciții nu încap; la ritm dublu încape la limită → `important`, nu `blocant` |
