...
SRC = Path(r"C:\00\Projects\LearningHub\content\tic\cls8\m1-excel-fundamente\lectia1-interfata.html")
...
TERMEN = {1: "adresa", 2: "coloana", 3: "b2:d6|interval", 4: "name box", 5: "sterg", 6: "formula bar",
          7: "formula bar", 8: "ctrl+end|ctrl + end", 9: "butonul +|+ de langa"}
for a in atomi:
