"""Copiat din lectia3-software/u9_verifica.py, adaptat la lectia4-ergonomie (13.09.2026). U9/U3 - verificari mecanice pe HTML-ul lectiei (Grep permis de protocol) + cheia chestionarelor.
...
F = Path(r"C:/00/Projects/LearningHub/content/tic/cls5/m1-sisteme/lectia4-ergonomie.html")
