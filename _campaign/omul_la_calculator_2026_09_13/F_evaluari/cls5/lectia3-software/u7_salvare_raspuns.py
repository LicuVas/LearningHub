# Copiat din lectia1-calculator/u7_salvare_raspuns.py, adaptat la lectia3-software (13.09.2026)
...
TEXT = "Software = programe, nu le atingi. Hardware = piese: monitor, tastatura. Software: Windows, Chrome."
