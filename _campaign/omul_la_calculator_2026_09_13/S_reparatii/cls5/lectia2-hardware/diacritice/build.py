...
NR = numarul liniei in bucata (1..120). Indentarea originala se pastreaza; fiecare linie noua
trebuie sa fie identica cu originalul dupa eliminarea diacriticelor. La final lipeste out_* in nou.html."""
import sys
