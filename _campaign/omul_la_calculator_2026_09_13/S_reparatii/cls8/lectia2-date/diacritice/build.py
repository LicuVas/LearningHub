...
D = Path(r"C:\00\Projects\LearningHub\_campaign\omul_la_calculator_2026_09_13\S_reparatii\cls8\lectia2-date\diacritice")
...
if len(sys.argv) > 1 and sys.argv[1] == "split":
    ...
    print("bucati:", (len(lines) + CH - 1) // CH, "CRLF:", any(l.endswith("\r\n") for l in lines))
    sys.exit(0)
